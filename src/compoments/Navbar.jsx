  ...
  return (
    <section class="header">
      <div class="header-websites">
        <Link to="#" class="active">Travellers</Link>
      ...
      <div class="navbar">
        <Link to="/" class="logo">
          <svg class="rw-header-logo__image" width="103" height="69" viewBox="0 0 265 70" role="img"
        ...
        <div class="nav-pages-container">
          ...
          <Link to="#" class="nav-link">Parking & Transport</Link>
          <Link to="#" class="nav-link">Shop, Taste & Discover</Link>
          <Link to="#" class="nav-link">Services</Link>
          <Link to="#" class="nav-link">Covid</Link>
        </div>
