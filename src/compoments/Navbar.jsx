...
function Navbar() {
  return (
    <section className="header">
      <div className="header-websites">
        <Link to="#" className="active">Travellers</Link>
        <Link to="#">All Schiphol websites
          <span className="fa-solid fa-chevron-down "></span>
        </Link>
      </div>
      <div className="navbar">
        <Link to="/" className="logo">
          <svg className="rw-header-logo__image" width="103" height="69" viewBox="0 0 265 70" role="img"
        ...
        <div className="nav-pages-container">
          ...
          <Link to="#" className="nav-link">Parking & Transport</Link>
          <Link to="#" className="nav-link">Shop, Taste & Discover</Link>
        ...
        <div className="header-sub-nav">
          ...
          <a href="#" className="fa-solid fa-magnifying-glass"></a>
